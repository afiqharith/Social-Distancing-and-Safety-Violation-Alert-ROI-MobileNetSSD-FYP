...
MegaPixels: Origins, Ethics, and Privacy Implications of Publicly Available Face Recognition Image Datasets [![Oxford TownCentre](https://img.shields.io/badge/Oxford_Town_Centre-URL-lightgrey)](https://megapixels.cc/)

A Camera Network Tracking (CamNeT) Dataset and Performance Baseline [![Oxford TownCentre](https://img.shields.io/badge/CamNeT-URL-lightgrey)](https://vcg.ece.ucr.edu/datasets)
